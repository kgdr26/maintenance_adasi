            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <small class="d-block mb-1 text-muted">Maintenance Overview</small>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-4">
                            ...
                            <h5 class="mb-0 pt-1 text-nowrap">10</h5>
                        ...
                        <div class="col-4 text-end">
                            ...
                            <h5 class="mb-0 pt-1 text-nowrap ms-lg-n3 ms-xl-0">8</h5>
                            <small class="text-muted">Machine</small>
                        </div>
                    </div>
            ...
            <div class="card h-100">
                <div class="card-header pb-0 d-flex justify-content-between mb-lg-n4">
                    <div class="card-title mb-0">
                        ...
                        <small class="text-muted">Montly Maintenance Overview</small>
                    </div>
                    <div class="dropdown">
                        ...
                        <div class="row gap-4 gap-sm-0">
                            <div class="col-12 col-sm-4">
                                <div class="d-flex gap-2 align-items-center">
                                    <div class="badge rounded bg-label-primary p-1"><i class="ti ti-chart-pie-4 ti-sm"></i>
                                    </div>
                                    <h6 class="mb-0">Closed Repair</h6>
                                </div>
                                <h4 class="my-2 pt-1 ps-4">6 Machine</h4>
                            ...
                            <div class="col-12 col-sm-4">
                                ...
                                <h4 class="my-2 pt-1 ps-4">2 Machine</h4>
                                <div class="progress w-75" style="height:4px">
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="d-flex gap-2 align-items-center">
                                    ...
                                    <h6 class="mb-0">Failed Repair</h6>
                                </div>
                                <h4 class="my-2 pt-1 ps-4">2 Machine</h4>
                                <div class="progress w-75" style="height:4px">
